...
Additionally, objects can have properties that shadow the built-ins on Object.prototype, potentially causing unintended behavior or denial-of-service security vulnerabilities.
