...
## References
- [Rule Source](https://github.com/oxc-project/oxc/blob/bd572c609b9fa4561c18485a4cf88716937c445d/crates/oxc_linter/src/rules/unicorn/prefer_logical_operator_over_ternary.rs)
```
