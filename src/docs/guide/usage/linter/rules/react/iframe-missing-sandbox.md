...
# react/iframe-missing-sandbox <Badge type="info" text="Correctness" />
...
- [Rule Source](https://github.com/oxc-project/oxc/blob/main/crates/oxc_linter/src/rules/react/iframe_missing_sandbox.rs)
