...
| `vue`        |          | [#481](https://github.com/oxc-project/oxc/issues/481)                                                            | Rules from [`eslint-plugin-vue`](https://github.com/vuejs/eslint-plugin-vue) that work with `<script>` tags                                                                      |
...
and `eslint-plugin-svelte`, we support rules that work with `<script>` tags in their source files.
