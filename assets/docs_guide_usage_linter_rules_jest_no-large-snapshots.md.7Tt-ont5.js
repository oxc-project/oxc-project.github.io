import{_ as n,c as l,j as a,a as s,I as e,a4 as p,o as t,E as h}from"./chunks/framework.D6UG3LSr.js";const _=JSON.parse('{"title":"jest/no-large-snapshots","description":"","frontmatter":{},"headers":[],"relativePath":"docs/guide/usage/linter/rules/jest/no-large-snapshots.md","filePath":"docs/guide/usage/linter/rules/jest/no-large-snapshots.md"}'),k={name:"docs/guide/usage/linter/rules/jest/no-large-snapshots.md"},F={id:"jest-no-large-snapshots",tabindex:"-1"},r=a("a",{class:"header-anchor",href:"#jest-no-large-snapshots","aria-label":'Permalink to "jest/no-large-snapshots <Badge type="info" text="Style" />"'},"​",-1),d=p(`<div class="rule-meta"></div><h3 id="what-it-does" tabindex="-1">What it does <a class="header-anchor" href="#what-it-does" aria-label="Permalink to &quot;What it does&quot;">​</a></h3><p>When using Jest&#39;s snapshot capability one should be mindful of the size of created snapshots. As a general best practice snapshots should be limited in size in order to be more manageable and reviewable. A stored snapshot is only as good as its review and as such keeping it short, sweet, and readable is important to allow for thorough reviews.</p><h3 id="example" tabindex="-1">Example <a class="header-anchor" href="#example" aria-label="Permalink to &quot;Example&quot;">​</a></h3><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// invalid</span></span>
