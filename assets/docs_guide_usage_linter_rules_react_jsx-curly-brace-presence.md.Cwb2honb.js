import{_ as i,c as a,j as e,a as s,I as n,a4 as l,o as r,E as o}from"./chunks/framework.D6UG3LSr.js";const x=JSON.parse('{"title":"react/jsx-curly-brace-presence","description":"","frontmatter":{},"headers":[],"relativePath":"docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.md","filePath":"docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.md"}'),p={name:"docs/guide/usage/linter/rules/react/jsx-curly-brace-presence.md"},h={id:"react-jsx-curly-brace-presence",tabindex:"-1"},d=e("a",{class:"header-anchor",href:"#react-jsx-curly-brace-presence","aria-label":'Permalink to "react/jsx-curly-brace-presence <Badge type="info" text="Style" />"'},"​",-1),c=l(`<div class="rule-meta"></div><h1 id="disallow-unnecessary-jsx-expressions-when-literals-alone-are" tabindex="-1">Disallow unnecessary JSX expressions when literals alone are <a class="header-anchor" href="#disallow-unnecessary-jsx-expressions-when-literals-alone-are" aria-label="Permalink to &quot;Disallow unnecessary JSX expressions when literals alone are&quot;">​</a></h1><p>sufficient or enforce JSX expressions on literals in JSX children or attributes (<code>react/jsx-curly-brace-presence</code>)</p><pre><code>🔧 This rule is automatically fixable by the [\`--fix\` CLI option](https://oxc-project.github.io/docs/guide/usage/linter/cli.html#fix-problems).
