...
For simpler legacy configuration files, you may also [migrate them to an ESLint flat config](https://www.npmjs.com/package/@eslint/migrate-config) first, and *then* to Oxlint using `@oxlint/migrate`.
